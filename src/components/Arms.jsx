...
export default function Arms() {
    ...
    const handleAddExercise = (exercise) => {
        const token = localStorage.getItem("token")
        api.post("/exercises", { ...exercise, muscleGroup: "Arms" })
    ...
    return (
        ...
        <div>
            ...
            <p> Select or add exercises for your arms and shoulder workout, or view previous workouts.</p>
